...
<body onload="loadLoginScripts()">
	<div class="box-form">
		<div class="left" id="loginleftpanel">
			<div class="overlay">
				<span class="head1">HBMS</span><br />
				<span class="head2">Hotel Bookings Management System</span>
				<hr>
		...
		<div class="right">
			<form id="frmLogin" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				...
				<div class="inputs">
					<input type="email" id="username" name="username" maxlength="25" placeholder="Username" required>
					<br>
