<?php
	...
	function sendPassword() {
		...
		try {
			...
			if(!empty($userDetails)) {
				$subject = 'Forget Password - HBMS!';
				$body = '
					<center><h2>Forget Password - HBMS!</h2></center>
					<p>Hi '.getManneredUserName($userDetails['first_name'], $userDetails['last_name']).',</p>
					<p>Below you can find login credentials. You can login into this Hotel Bookings Management System by visiting <a href="http://localhost/HotelBookingsManagementSystem/index.php" target="_blank"><b>HBMS</b></a> this link.</p>
					<p><b>Username : </b>'.$userDetails['email'].'<br /><b>Password : </b>'.base64_decode($userDetails['password']).'</p>
					<p>In case if you have any difficulty please <a href = "mailto:HotelBooking@gmail.com">eMail</a> us.</p>
					<p>Thank you,<br />
					<b>HBMS - Hotel Bookings Management System</b?</p>
				';
	...
	function validateSignUp() {
		...
		$subject = 'Welcome to HBMS!';
		$body = '
			<center><h2>Welcome to HBMS!</h2></center>
			<p>Hi '.getManneredUserName($fname, $lname).',</p>
			<p>Your account is created successfully, so now you can login into this Hotel Bookings Management System by visiting <a href="http://localhost/HotelBookingsManagementSystem/index.php" target="_blank"><b>HBMS</b></a> this link. Below you can find login credentials.</a></p>
