<?php
	...
	function deleteAccount() {
		...
		$subject = 'HBMS Account Deletion!';
		$body = '
			<center><h2>HBMS Account Deletion!</h2></center>
			<p>Hi '.getManneredUserName().',</p>
			<p>It&#39;s really sad to say Good-Bye, it has been great journey till now. We will miss you!</p>
			<p>Just in case if you change your mind and choose to join us again, visit <a href="http://localhost/HotelBookingsManagementSystem/index.php" target="_blank"><b>HBMS</b></a> to create new account. Wishing you best regards.</p>
			<p>Thank you,<br />
