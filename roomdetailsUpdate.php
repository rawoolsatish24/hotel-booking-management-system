<?php
	...
	function bookRoom() {
		try {
			...
			$subject = 'New Room Booking - HBMS!';
			$body = '
				<center><h2>New Room Booking - HBMS!</h2></center>
				<p>Hi '.getManneredUserName().',</p>
				<p>Thank you for booking room with us. Below you can find room booking details. You have to wait until you get approval mail from us. Also, you can track your booking status by visiting <a href="http://localhost/HotelBookingsManagementSystem/index.php" target="_blank"><b>HBMS</b></a> this link.</p>
